...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Atende+Empresas — Atendente de WhatsApp com IA + CRM Kanban" },
      { name: "description", content: "Conecte o WhatsApp, deixe a IA atender e organize seus leads em um kanban arrastável." },
      { name: "author", content: "Atende+Empresas" },
      { property: "og:title", content: "Atende+Empresas — Atendente de WhatsApp com IA + CRM Kanban" },
      ...
      { name: "twitter:title", content: "Atende+Empresas — Atendente de WhatsApp com IA + CRM Kanban" },
    ...
    links: [
      { rel: "icon", type: "image/svg+xml", href: "/logo-mascot.svg" },
